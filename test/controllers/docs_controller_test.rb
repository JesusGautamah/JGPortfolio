...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { link: @doc.link, project_id: @doc.project_id, title: @doc.title } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { link: @doc.link, project_id: @doc.project_id, title: @doc.title } }
